...
! !DESCRIPTION:
!
! Periodic/Neumann conditions for global domain boundaries. \! Assumptions:  a *single* row of ghost cells (num-ghost-cells=1); \! work1 array has form (i-index,j-index,number-arrays)
!
! !REVISION HISTORY:
!
! authors: Tony Craig, NCAR
